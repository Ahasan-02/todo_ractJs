...
const Todo = () => {
  ...
  return (
    <div className='bg-gray-200 place-self-center w-11/12 max-w-md flex flex-col p-7 min-h-[550px] rounded-xl'>
        ...
        {/*------input-----*/}
        <div className='flex item-center my-7 bg-white rounded-full'>
            <input ref={inputRef}
            className='text-gray-500 bg-transparent border-0 outline-none flex-1 h-14 pl-6 pr-2 placeholder:text-state-600'
